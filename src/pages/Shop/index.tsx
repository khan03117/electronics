...
const Shop = () => {
    ...
    return (
        <>
            ...
            <section id="productitem" className="py-20">
                <div className="container mx-auto">
                    <div className="grid lg:grid-cols-5 grid-col-1">
                        <div className="col-span-1">
                            <div className="w-full px-4 py-2 sticky top-0">
                                    ...
                                    <div className="flex flex-wrap gap-3 *:border *:border-blue-gray-900  ">
                                        {
                                            colors.map((itm) => (
                                                <>
                                                    <button style={{ background: `${itm}` }} className={`size-9 rounded-full`}></button>
                                                </>
                                            ))
                                        }
                                    </div>
